...
def main():
  ...
  plistpath = scriptpath + "/resources/IPlugGen-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugGen-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugGen-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugGen-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugGen-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugGen-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/IPlugGen-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/IPlugGen.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/IPlugGen.iss",inplace=1):
